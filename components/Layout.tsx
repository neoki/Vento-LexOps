...
import { LayoutDashboard, Inbox, FileText, Calendar, ShieldCheck, Settings, Bell, Search, User, Briefcase } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, activeScreen, onNavigate }) => {
  const navItems = [
    ...
    { id: 'audit', label: 'Auditoría', icon: <ShieldCheck size={20} /> },
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-xl z-20">
        ...
        <div className="p-4 border-t border-slate-700 bg-slate-900">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-sm font-medium">Elena Martín</p>
                    <p className="text-xs text-slate-400">Responsable Jurídico</p>
                </div>
            </div>
        </div>
      </aside>
